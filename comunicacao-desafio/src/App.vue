<template>
	<div id="app">
		<usuario-lista :usuarios="usuarios" @selecinouUsuario="foiSelecionado($event)"/>
		<usuario-detalhe :selecionado="selecionado"/>
	</div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      selecionado: { id: 0, nome: "", idade: 0 },
    };
  },
  methods: {
    foiSelecionado(usuario) {
      //alert(`Chegou no app! ${usuario.id} ${usuario.nome} ${usuario.idade}`);
